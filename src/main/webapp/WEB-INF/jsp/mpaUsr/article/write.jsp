	...
	<div class="container mx-auto">
        <form method="POST" action="doWrite" onsubmit="ArticleWrite__submitForm(this); return false;">
            <div class="form-control">
                ...
                <input class="w-full input input-bordered" type="text" maxlength="100" name="title" placeholder="제목을 입력해주세요." />
            </div>
            ...
            <div class="mt-4 btn-wrap gap-1">
                ...
                <button type="submit" class="btn btn-sm mb-1" title="자세히 보기">
